...
// ── pLimit (inline concurrency limiter) ───────────────────────────────────────
...
// ── Canvas-based image processor (replaces Web Worker) ───────────────────────
...
export default function IMGResizer(){
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white font-sans">
      ...
      {/* Header */}
      <header className="sticky top-14 z-10 border-b border-gray-800 bg-gray-950/90 backdrop-blur px-6 py-3 flex items-center justify-between">
